...
public class ClickHouseMetadata implements DatabaseMetadata {
    ...
    public XADataSource buildXaDataSource() {
        ...
        // ClickHouse does not have a specific XA DataSource implementation in the test scope
        throw new UnsupportedOperationException("ClickHouse XA DataSource not supported in tests");
    }
