...
public class ClickHouseDialectConverter extends AbstractDialectConverter {
    ...
    public JdbcDeserializationConverter createInternalConverter(LogicalType type) {
        JdbcDeserializationConverter delegate = super.createInternalConverter(type);
        ...
        switch (root) {
            case DATE:
                return val -> {
                    ...
                    return delegate.deserialize(val);
                };
            ...
            case TIMESTAMP_WITHOUT_TIME_ZONE:
                return val -> {
                    if (val instanceof OffsetDateTime) {
                        ...
                        return TimestampData.fromLocalDateTime(offsetDateTime.toLocalDateTime());
                    }
                    return delegate.deserialize(val);
                };
            default:
